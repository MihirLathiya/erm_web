...
//
//     final getSingleTaskResponseModel = getSingleTaskResponseModelFromJson(jsonString);

import 'dart:convert';

GetSingleTaskResponseModel getSingleTaskResponseModelFromJson(String str) =>
    GetSingleTaskResponseModel.fromJson(json.decode(str));

String getSingleTaskResponseModelToJson(GetSingleTaskResponseModel data) =>
    json.encode(data.toJson());

class GetSingleTaskResponseModel {
  String? id;
  String? title;
  dynamic description;
  DateTime? dueDate;
  ...
  factory GetSingleTaskResponseModel.fromJson(Map<String, dynamic> json) =>
      GetSingleTaskResponseModel(
        id: json["id"],
        title: json["title"],
